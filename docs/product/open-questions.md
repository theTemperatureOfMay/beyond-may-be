...
| 2.1.2·2.2.2 | 추천 장소 추가 제공 계약 | `POST /api/v1/recommendations/{batchNumber}/reactions`로 회차별 반응 교체, 미노출 후보 부족 시 TourAPI 1회 보충, 최종 싫어요 재추천과 후보 소진 응답 구현 완료 |
| 1.2.2·2.1.2 | 사색러와 기억러의 장소 범위 경계 | `기억러는 5·18·민주화 전용이 아니라 역사 건축물·역사 장소 대상, 사색러와의 상세 경계 [결정 필요]` |
| 4.4.1 | TourAPI 주변 장소 수집·주기적 전체 갱신과 실패 대체 | `추천 생성의 변경분 1회 보충은 ADR-0014로 확정, 주변·주기 갱신 정책 [결정 필요]` |
